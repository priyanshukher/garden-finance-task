...
const StakingComponent: React.FC = () => {
  ...
  return (
    <div className="staking-component">
      ...
      <hr />
      <Stake amount={amount} setAmount={setAmount} />
    </div>
  );
};
...
const StakingAmount: React.FC<StakingAmountComponentProps> = ({
  ...
  return (
    <div className="staking-component-middle-section">
      ...
      />
      <InputField id="staked" label="Staked Amount" value={stakedAmount} />
    </div>
  );
};
...
type StakeAndAddressComponentProps = {
  amount: AmountState;
  setAmount: React.Dispatch<React.SetStateAction<AmountState>>;
};
...
const Stake: React.FC<StakeAndAddressComponentProps> = ({
    ...
    const getAddress = async () => {
      if (isSigned) {
        try {
          ...
          console.error("Failed to fetch stake address:", error);
        }
      }
    };
    getAddress();
  ...
  const handleStake = async () => {
    ...
    setAmount({ tokenAmount: null, stakedAmount: null }); // Clear input values
